...
<input type="submit" value="Search" class="btn btn-primary">
	...
	<div class="col-sm-2">
			...
			<a id="sjob" href="job.php?id=<?php echo urlencode($r->id); ?>">
			<h3 class="text-success"><?php echo $r->title;?>(<?php echo $r->city," ",$r->state;?>)</a></h3>
						...
						<?php echo "<p class='text-success'> posted on  ",format_date($r->created),'</p>';?>
	                        <p><?php
